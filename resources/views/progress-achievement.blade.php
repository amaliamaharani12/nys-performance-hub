...
<body>
                    ...
                    <div class="action-bar">
                        ...
                        <div class="dropdown-wrap">
                            ...
                            <div class="dropdown-menu" id="printMenu">
                                ...
                                <div class="menu-note">Excel didownload dulu, print manual dari aplikasi Excel-nya
                                    ya.</div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // ─── Export: Unduh & Print (Excel / PDF / Gambar) ─────────────────────
        ...
        function captureItemsAsCanvas(callback) {
            const target = document.getElementById('itemsGrid');
            html2canvas(target, { backgroundColor: '#f4f6f9', scale: 2, useCORS: true }).then(callback);
        }

        function downloadImage() {
            captureItemsAsCanvas(function (canvas) {
        ...
        function printPdf() {
            // PDF-nya kebuka di tab baru, tinggal pencet tombol print di viewer PDF-nya
        ...
        function printExcelNotice() {
            alert('Excel ga bisa langsung diprint dari browser. File-nya bakal didownload — print manual dari aplikasi Excel-nya ya.');
            downloadExcel();
        }
    </script>
